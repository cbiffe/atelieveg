		...
		<?php endif; } } else { ?>
			<div class="col-lg-3 col-md-3 col-sm-6">	
				<div class="funfact-inner text-center">
					...
					<p class="description"><?php _e('Happy Customer','webriti-companion'); ?></p>
				</div>  
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6">		
				<div class="funfact-inner text-center">
					...
					<h1 class="funfact-title"><?php echo '2500'; ?></h1>
					<p class="description"><?php _e('Finish Projects','webriti-companion'); ?></p>
				</div>  
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6">		
				<div class="funfact-inner text-center">
					...
					<p class="description"><?php _e('Business Growth','webriti-companion'); ?></p>
				</div>  
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6">			
				<div class="funfact-inner text-center">
					...
					<p class="description"><?php _e('Cups of Coffee','webriti-companion'); ?></p>
				</div>  
			</div>
		<?php } ?>
		</div>	 
